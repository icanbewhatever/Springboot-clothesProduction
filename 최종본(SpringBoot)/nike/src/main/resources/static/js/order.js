...
for (let i = 0; i < btn1.length; i++) {
    btn1[i].addEventListener("dblclick", () => {
        ...
        var orderNum2 = btn1[i].parentElement.querySelector(".ordernum").innerText.trim();
        ...
        document.getElementById("requester").value = requesterValue;
         ...
         // 주문 번호 설정
        document.getElementById("num").value = orderNum;
        document.getElementById("num2").value = orderNum2;
        console.log('num2', orderNum2);
