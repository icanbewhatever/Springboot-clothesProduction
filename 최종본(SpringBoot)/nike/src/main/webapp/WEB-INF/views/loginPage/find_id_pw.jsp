...
<body>
<div class="conteiner">
    <form action="find_id_process" method="post" class="find_id_box">
        <h3>아이디 찾기</h3>
        ...
        <input type="button" value="뒤로가기" onclick="location.href='index'" class="back_but">
    </form>
    
     <form action="find_pw_process" method="post" class="find_pw_box">
        <h3>비밀번호 찾기</h3>
