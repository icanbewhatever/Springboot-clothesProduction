...
<div class="conteiner">
    <div class="withe_box">
            ...
            <form action="login" id="form1" class="log_box" method="post">
              <div class="id_box">  
                <input type="text" name="id" id="id" class="id_put" />
                    <span class="material-symbols-outlined">
                        person
                    </span>
              </div>
              <div class="pw_box">       
                <input type="password" name="pw" id="pw" class="pw_put" />
                    <span class="material-symbols-outlined">
                        visibility_off
                    </span>
              </div>
        ...
        <div class="check">
              <span class="input_wrap">
                ...
                <div class="check_pw">
                    <a href="find_id_pw" class="ck_pw">아이디 / 비밀번호 찾기</a><br>
                </div>
                <div class="check_id">
                    <a href="sign_up_form" class="ck_id">계정생성</a>
                </div>
            </div>
        </div>
    </div>
